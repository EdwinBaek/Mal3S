...
class MalD3S_Dataset(Dataset):
    def __init__(self, mode, transform=None):
        ...
        if mode == 'train':
            ...
            for idx in range(len(self.apicall_image)):
...
class EarlyStopping:
    ...
    def save_checkpoint(self, val_loss, model1):
        ...
        torch.save(model1.state_dict(), './Checkpoint/Single_APICall_ft-%s_hc-%s_oc-%s_hp-%s_op-%s_loss-%s_checkpoint.pt' % (fastText_size, self.hyperparameter[0], self.hyperparameter[1], self.hyperparameter[2], self.hyperparameter[3], self.hyperparameter[4]))
...
if __name__ == '__main__':
    ...
    # Test
    model.load_state_dict(torch.load('./Checkpoint/Single_APICall_ft-%s_hc-%s_oc-%s_hp-%s_op-%s_loss-%s_checkpoint.pt' % (fastText_size, hyperparameter[0], hyperparameter[1], hyperparameter[2], hyperparameter[3], hyperparameter[4])))
    model.eval()
    ...
    with open('./Result/Single_APICall_ft-%s_hc-%s_oc-%s_hp-%s_op-%s_loss-%s_test_result.csv' % (fastText_size, hyperparameter[0], hyperparameter[1], hyperparameter[2], hyperparameter[3], hyperparameter[4]), 'w', newline='') as file:
    ...
    with open('./Result/Single_APICall_ft-%s_hc-%s_oc-%s_hp-%s_op-%s_loss-%s_train_valid_recode.csv' % (fastText_size, hyperparameter[0], hyperparameter[1], hyperparameter[2], hyperparameter[3],hyperparameter[4]), 'w', newline='') as file:
        write = csv.writer(file)
